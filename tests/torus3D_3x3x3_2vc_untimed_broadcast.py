...
#
# Variant of torus3D_3x3x3_2vc_testnic.py with send_untimed_broadcast=true.
#
# This is the only test that exercises Torus3DTopo::routeUntimedBroadcastPacket()
# and Torus3DTopo::sendBroadcast(), which flood across 6 directions (+/-X, +/-Y,
# +/-Z) with wrap-aware logic distinct from both the mesh and 2D torus broadcast
# implementations.
#
...
testname = "torus3D_3x3x3_2vc_untimed_broadcast"
    ...
    for z in range(z_size):
        for y in range(y_size):
            for x in range(x_size):
                ...
                rtr_topo.addParams({"verbose": 0, "xDim": x_size, "yDim": y_size, "zDim": z_size})
