...
#
# 3-VC variant of torus5x5_2vc_testnic.py using the standard SimpleNetwork
# (mordred.mordredNIC) transport path.
#
# Exercises VcAllocRR with 3 VCs on the 2D torus: VC0 for non-wrap links,
# VC1 for wrap-around links (deadlock avoidance), VC2 available for traffic
# class separation — stressing the VC round-robin logic beyond the minimum
# 2-VC deadlock-free configuration.
#
