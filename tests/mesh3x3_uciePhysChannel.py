...
#
# uciePhysChannel variant of mesh3x3_testnic.py.
#
# Every link in the 3x3 mesh uses prydwen.uciePhysChannel as the
# physical transport.  All router ports are wired with rtrPortControlPC;
# all endpoints use mordredNicPC.  The topology and traffic parameters are
...
testname = "mesh3x3_uciePhysChannel"
