# Modified from Kingsley
from sst_unittest import *
from sst_unittest_support import *


class testcase_mordred(SSTTestCase):
...
#####
    ...
    def test_mordred_torus3D_3x3x3_2vc_testnic(self):
        self.mordred_test_template("torus3D_3x3x3_2vc_testnic")

    # Add subsequent tests here...

#####

    def mordred_test_template(self, testcase):
        ...
        testDataFileName="test_mordred_{0}".format(testcase)
        ...
        if os_test_file(errfile, "-s"):
            log_testing_note("Mordred test {0} has a Non-Empty Error File {1}".format(testDataFileName, errfile))
