...
public:
  ...
  */
  void setNotifyOnReceive( SimpleNetwork::HandlerBase* functor ) override { receiveFunctor = functor; }
  ...
  */
  void setNotifyOnSend( SimpleNetwork::HandlerBase* functor ) override { sendFunctor = functor; }
