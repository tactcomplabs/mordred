...
| 1     | - (r) Router report <br> - (r) Router ID <br> - (r) Port Number | (r) Connection type <br> - If Router <br>   - (r) Router ID <br>   - (r) Port Number <br> - Else (endpoint) <br> - (s) Num VCs <br> - (s) Flit Width <br> - (s) Bus Width |
| 2 | - (r) Num VCs <br> - (r) Flit Width <br> - (r) Bus Width | If connection_type = Endpoint <br> - (s) Endpoint ID |
